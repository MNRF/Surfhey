...
public class itemSurf {
    ...
    public static Timestamp[] itemtimestampCreated = new Timestamp[0];

    public static void updateData(String[] authorname , String[] imageurls, String[] dates, String[] titles, String[] details, String[] likes, Timestamp[] timeStampCreated) {
        ...
        itemDetail = details;
        itemLikes = likes;
        itemtimestampCreated = timeStampCreated;
